...
export default function ServicesBento() {
    ...
    return (
        <section id="filosofia" className="relative py-16 px-6 lg:px-12 w-full max-w-7xl mx-auto">
...
<motion.div variants={itemFade}>
    {/* Applicato bordo blue, hover accent e transizione di colore[cite: 2, 4] */}
    <LiquidCard className="p-8 h-full flex flex-col justify-between group shadow-none border border-blue hover:border-accent bg-white rounded-[2rem] transition-colors duration-300">
        ...
        <div>
            <h3 className="text-2xl font-bold font-sans tracking-tight mb-4 text-blue group-hover:text-accent transition-colors">Art Direction <br /> & Strategy</h3>
...
<motion.div variants={itemFade}>
    <LiquidCard className="p-8 h-full flex flex-col justify-between group shadow-none border border-blue hover:border-accent bg-white rounded-[2rem] transition-colors duration-300">
        ...
        <div>
            <h3 className="text-2xl font-bold font-sans tracking-tight mb-4 text-blue group-hover:text-accent transition-colors">Brand Identity <br /> & Growth</h3>
            <p className="text-zinc-500 font-sans leading-relaxed">
...
<motion.div variants={itemFade}>
    <LiquidCard className="p-8 h-full flex flex-col justify-between group shadow-none border border-blue hover:border-accent bg-white rounded-[2rem] transition-colors duration-300">
        ...
        <div>
            <h3 className="text-2xl font-bold font-sans tracking-tight mb-4 text-blue group-hover:text-accent transition-colors">UX/UI <br /> & Conversion</h3>
            <p className="text-zinc-500 font-sans leading-relaxed">
